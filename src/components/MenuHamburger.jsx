  ...
  return (
    <div className="flex items-center justify-end p-8">
      <div className="MOBILE-MENU flex">
        <div
          className="space-y-2 animate-pulse hover:cursor-pointer"
          onClick={() => setIsNavOpen((prev) => !prev)}
        >
           <svg className="swap-off fill-current" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512"><path d="M64,384H448V341.33H64Zm0-106.67H448V234.67H64ZM64,128v42.67H448V128Z"/></svg>
        </div>

        <div className={isNavOpen ? "absolute w-[100%] h-[100vh] top-0 left-0 bg-[#171212] z-10 flex flex-col justify-evenly items-center" : "hidden"}>
          <div
